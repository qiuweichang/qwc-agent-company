...
describe('OrchestratorPane three-state UI', () => {
  test('starting: shows passive startup state without a manual Start Department Manager CTA', () => {
    ...
    expect(screen.getByTestId('empty-state-title')).toHaveTextContent('Starting Department Manager')
  ...
  test('stopped: shows explicit Start Department Manager CTA', () => {
